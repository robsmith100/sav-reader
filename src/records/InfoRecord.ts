...
export class InfoRecord{
    ...
    public recTypeStr: string;
    public subType: number;
    public subTypeStr: string;
    public size: number;
    public count: number;
    public byteData: any;
    ...
    static async read(reader: ChunkReader, meta: SavMeta){
        ...
        if( subType == 3 ){
            ...
            for( let p in pairs) {
                ...
                let sysvar = meta.sysvars.find((x: SysVar) => x.shortName === name);
                if( sysvar != null ){
