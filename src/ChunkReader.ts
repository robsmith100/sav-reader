import { PeekableAsyncReader } from "./PeekableAsyncReader";
...
export class ChunkReader{
    ...
    async readDouble2(compression: any){
        if (compression == null)
    ...
    async read8CharString(compression: any){
        if (compression == null)
    ...
    async readString(len: number, trimEnd = false){
